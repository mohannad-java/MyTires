<?php
    ...
    Class AddProductsContr extends Products {
        ...
        public function __construct($userid, $image_name, $image_size, $tmp_name, $image_erorr, $name, $dec, $price, $size1, $size2, $ring, $qty) {
            $this->userid = $userid;
        ...
        private function emptyInput() {
                ...
                $result;
                if (empty($this->userid) || empty($this->image_name) || empty($this->name) || empty($this->price) 
            ...
            if($this->image_erorr === 0) {
                if($this->image_size > 12500000) {
                    ...
                    if(in_array($image_ex_lc, $allowed_exs)) {
                        ...
                        $this->setProduct($this->userid, $this->new_image_name, $this->name, $this->dec, $this->price, $this->size1, $this->size2, $this->ring, $this->qty);
                    } else {
                        return 'allowed';
                    }
                }
